...
title: Hay & Products
description: Premium Alfalfa and Mix Hay Bales available at Rancho La Capillita.
---

<div class="container mx-auto px-4 py-8">
  <h1 class="text-4xl font-bold text-ranch-green-dark mb-2">Our Hay Products</h1>
  <p class="text-stone-600 mb-8 max-w-2xl text-lg">
    Quality hay grown with care in Yuma, AZ. We offer competitive pricing for local pickup.
  </p>

  <div class="grid md:grid-cols-2 gap-8">
    <div class="bg-ranch-light p-8 rounded-2xl border border-stone-200 hover:shadow-md transition-shadow">
      <div class="flex items-center justify-between mb-4">
        <h2 class="text-2xl font-bold text-ranch-green-dark">Premium Alfalfa</h2>
        <span class="bg-ranch-green text-white px-3 py-1 rounded-full text-sm font-medium">In Stock</span>
      </div>
      <p class="text-stone-700 mb-6 font-medium">High protein, leafy, and clean. Perfect for dairy cows and horses.</p>
